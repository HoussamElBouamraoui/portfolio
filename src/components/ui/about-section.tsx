      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="elite-card p-8 magnetic">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-elite-purple/20 rounded-lg pulse-elite">
                  <Shield className="h-6 w-6 text-elite-purple" />
                </div>
                <div>
            ...
            <div className="elite-card p-8 magnetic">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-elite-white/20 rounded-lg pulse-elite">
                  <Zap className="h-6 w-6 text-elite-white" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-elite-white">Excellence Académique</h3>
                  <p className="text-elite-white/70">
            ...
            <div className="elite-card p-8 magnetic">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-elite-purple/30 rounded-lg pulse-elite">
                  <Code className="h-6 w-6 text-elite-purple-light" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-elite-white">Développement Orienté Sécurité</h3>
                  <p className="text-elite-white/70">
          ...
          <div className="elite-card p-8 magnetic">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.map((skill) => (
                <Badge 
                  key={skill} 
                  variant="outline" 
                  className="elite-glow border-elite-purple/30 text-elite-purple hover:bg-elite-purple/20 hover:border-elite-purple transition-all duration-300 magnetic"
                >
                  {skill}
                </Badge>
              ))}
            ...
            <div className="mt-8 pt-6 border-t border-elite-purple/20">
              <h4 className="font-medium mb-4 text-elite-purple text-center">
                🛠️ Outils favoris
              </h4>
              <ul className="text-sm text-elite-white/60 space-y-2">
